...
- Espoo, Otaniemi, +5C
- Lohja, foggy, +2°C
- Uppsala, Sweden, cloudy
- Tartu, Estonia, partly cloudy, +6
- Gothenburg, Sweden, cloudy as always, +2C
- Kirkkonummi, Finland, windowless room, so no idea ;)
- Berlin, Germany, finally sunny ;)
- Copenhagen (well, Lyngby), Denmark, +10°C 🌞
- Roskilde, Denmark,+6°C 
- Oulu, Finland, Cloudy, I guess +2 now? :cloud: 
- Lyngby, Denmark, 5°C and sun
- Toulouse, France, +9°C and sunny
- Oslo, Cloudy, +2°C
- Stockholm, Sweden ,overcast
- Reykjavik, Iceland, 0°C (very) Windy +2
- Southampton, UK, +10°C and cloudy
- Espoo, Finland very misty
- Umeå, Sweden (+1°C, clowdy and rainy)
- Tartu, Estonia from the physical room and the weather is a bit warm :)
- Kilifi, Kenya 29°C 
- Denmark, DTU, sunny, but only 3-4°C ☀️☀️☀️
- Karlsruhe, Southern Germany, 8 C and cloudy
- Tampere, Finland: Pretty grey and sad!
- Tampere also, can confirm
- MojMo, Denmark, surprisingly sunny here!
- Espoo, Finland, total fog, tuntuu kuin 2°C
- Tübingen (DE), somewhat cloudy but its getting better, +6
- Stockholm, Sweden, +5°C cloudy 
- Småland, Sweden, +2°C foggy and drizzle
- Helsinki, Finland, +2°C very foggy
- Tampere, Gray and dark
- Lausanne, Switzerland, 7°C, sunny
- Jena, Germany, 7 °C
- Barcelona, Spain, 15ºC, quite sunny.
- Wrocław, cloude, 6 °C
- Warsaw, Poland, sunny, +8°C
- .Espoo, foggy, +3°C
- .london, as usual :)
- Bochum, Germany, cloudy, +8°C
- London, cloudy :) 
- Joensuu, Finland. Cloudy and grey.
- Åbo, Finland. Grey +3ºC
- Knivsta, Sweden. Cloudy and 5ºC
- Stockholm, 4 °C
- Gothenburg, Sweden, cloudy
- Lyngby, DK ☀️
- Kuopio, Finland, 2°C, cloudy
- Stockholm, Sweden, Earth, Cold and Gloomy but happy
- Stuttgart, Germany, 6° and cloudy
- Krakow, Poland, sunny but cold
- Aarhus, Denmark, sunny ☀️
- Uppsala, Sweden, cloudy and windy
- Trondheim, Norway, sunny and 6 °C 🌞
- Tartu, Estonia: +6C with a window to the sunny south side
- Stockholm, Sweden, grey and gloomy
- Lempäälä, Finland, cloudy
- Berlin, Germany, sunny 6°C 
- London, UK, grey skies (surprise)
- Gothenburg, Sweden, cloudy..
- Dar es salaam is sunny 31 degrees celsius
- Ioannina city, cloudy, 12 C
- Copenhagen, sunny but cold!
- Trondheim, Norway - almost summer temp (LOLOL)
- Aalborg, Denmark- 6 degrees
- Krakow, Poland, good sunny day but a bit chilly
- Stockholm, cloudy
- Espoo, cloudy
- London, UK 11 degrees wow! 
- Dhivya, Finland, 4°, 
- London
- Barcelona, +14 
- Groningen, Netherlands, 8 deg celsius
- Oslo, Norway, 3°, grey 
- Kannelmäki, Helsinki
- Espoo!
- Kuopio, Finland, grey +2°
- Tallinn, Estonia, +4
- Espoo, Finland, +4
- Stockholm, from onsite library at KTH, getting to spring slowly but surely
- 
#### How are you attending this workshop?

Poll: Add an 'o' to the answer that applies to you

- By myself: ooooooooooooooooooooooooooooooooooooooooooooo
- With colleagues/research groups: oo
- In a classroom: oooooooooo
- From the streaming
- From the streaming room! :D oo
- From home :smile: +1 ;) :o :o
- From my home office 
- From my classroom at Reykjavík University
- By myself at home
- From somewhere on campus o
- From the streaming room! :)
- From my desk at university ooo
- By myself from my home office oooo
- From the officeeee
- By myself from the university 
- At Imperial College London o
- Having coffee ;) 
- From the office
- From the stream room
- From office ooo
- From streaming at home
- From the broadcasting room ;) write in the notes if something is off with the streaming, we're keeping an eye here too.
- From home
- From home :)
- From the office +1
- From the office o
- From my desk at uni, my PhD students have absconded with my 8 month old, normal Tuesday behaviour 

Comments: 

- If we miss any session, would recordings be available later on?
  - Yes! But the joy is to do everything together. They will be available on Twitch from some time and then they will be moved to YouTube (AFAIK) - yes :) 

- it is fun that we can see the live editing of the page in the view mode as well
  - The server does not like that much but we don't care!! 
    Actually we do. With more than ~100 participants it may lag a bit,
    consider switching to "read only mode" if you don't plan writing anything, which might help the cpu of the notes server :-)
 
- i'm a bit confused, bc there are 3 modes: view, both, and edit. 
  - The hyrbid mode is not really needed (it is more useful when you want to see the rendered output of what you write), so use edit when you want to ask something and view when you are done :)
  - got it. well... w/e i guess it doesn't matter what i was trying to say :)

---

## [Intro and Welcome](https://github.com/coderefinery/workshop-intro/blob/master/livestream.md)

- How to change twitch to source?
    - Down-right corner, gear-like looking wheel (Settings), and then  "quality" 
...
- I'm not sure I got what a "commit" is? I can see Branches, but I don't get where to look for the "commits"
  ...
  - commit is indicated by its id, i.e., hash which is something like `9ce4dce`
...
- Recently there have been some controversies around GitHub, mainly in Europe. What is your experience with using european alternatives like e.g. Codeberg? +1
  - I am using codeberg, it has all the basic features of GitHub but perhaps it is not yet polished as GitHub. It is perfectly useable though. Most of what you learn about github will apply there
    - I heared that Codeberg lacks some features like "github ~~workflows~~ actions", is it the case?
...
- Perhaps elaborate difference between file copy of project directory, git clone of project, and fork of project?
  ...
  - just copying a directory with files in it might be doing something like "cloning" if you also copy the `.git` directory in it.
...
## [Copy and browse an existing project](coderefinery.github.io/git-intro/browsing/)


### [Exercise: Browsing an existing project](https://coderefinery.github.io/git-intro/browsing/#exercise)

Exercise + break, back on stream xx:20
...
- what is the the "network grap"? where do I find it? and the branches?.
    - on the top (in the menu where there is `Code`, `Issues`) go to "insights" -> "network" on the left.
    - I am totally lost.
    - When you open the repository, you have one line that starts with the github logo, which tells you which repository, and after that  `Code`, `Issues` etc, which are essentially clickable links, though they don't look like it.
...
- We have a learner using an old MacBook air (intel probably) without enough disk space installing Xcode when following the git installation. Any recommendation?
    - so `xcode-select --install` did not work? is `brew` available on this machine?
    ...
    - Did you try [macports](https://www.macports.org/)?
...
- how to look for the recipes including the ingredient “salt”?
    - if you are in the landing page of the github respository, just type `/` and the search term
...
- Is it possible to commit only parts of files in a directory to a repository? Ie: working in RStudio on a dataset, what if I want to version the code, but  dont want to copy the dataset to github.
  - yes, on your local computer, you can:
    - from the command line use `git add -p` (where `-p` means "patch"), and you will get an interactive prompt where you can chose what to add..  more on that later in the lesson.
  ...
  - I think this question is about commiting only some files in a directory, rather than only some parts of files
    - That is typically the default. If your files are small enough, typically you can just `git add` all the changes to  particular file that you changed... but this will be discussed later in the lesson.
...
- When using gitignore, do i put make this as a directory, or is it a text document to list the files to "ignore"?
  - it is a text file called `.gitignore` that lists the files (or filename patterns) to ignore. You can have one `.gitignore` file per directory, 
    - OKIE! Thanks!

- But it is possible to change your commit message afterwards, right?
  - you can, but it's a bit cumbersome... and it gets more complicated if you also shared already the commit (you "git push"-ed). If it's just the last commit and you haven't pushed anywhere yet, you can change the commit completely with `git commit --amend`.
...
- So talking about versioning locally vs on github, as long as you avoid 'push' you can do everything fine locally? THis is what a quick google tells me, and I am interested in saving potentially sensiive data from exposure to github. 
    - yes, you can work only locally. depending on what kind of sensitive data we are talking about you can use a git-extension like `git-annex` and upload your sensitive data to a trusted server outside github even though your code is stored on github. I believe we will talk about it next week. 
        - I am referring to sensitive patient data. 
            - in general, github (or other platforms like gitlab) are for storing code (there is a size limit on your repository). if you would like to store data that you wish to version, there are other alternatives (git-annex, DVC).
                - I want to version the code, not the data - I just ask because often this metadata will be stored in the same directory as the Rproject itself. (So I suppose either you change that structure or you use gitignore).
                    - I see. in that case, best those "metadata" in a seperate file and list it inside `.gitignore` so that your code itself does not include these sensitive metadata. does this help?
                ...
                - I often use a structure where I have a project folder, then "data/" and "scripts/" folders within that. I can either just track the "scripts/" folder in git, or if I have other files I want to track too, I can exclude the whole "data/" folder in my `.gitignore`. Maybe a similar structure would work for you
...
- If I "fork" a repository in GitHub, and I "git clone" the same repository in bash cmd line in my local files, are these two considered different and separate repos? How will I make "connection" between them?
  ...
  - if you fork a repository on GitHub, but then you clone *the original repository*, then your fork and the local repository on your computer are not connected. But you can connect them:  
     ...
     1. add another remote, called "mine", rename as appropriate:  
        `git remote add mine URL-to-my-fork`
     2. change the URL of the existing "origin" remote:
...
- This might be a stupid question, but if you are working on a secure env, as is the case with Finnish register data, how do you use version control? My expereince is that these envs are isolated from the internet
  - You can run git locally and use it for version control that way. If you use command line to interact with the secure env, see if the command `git` exists.
...
- How can we do version control if we are using any secure environment to analyze data?
  ...
  - Three examples of cloned projects:
    ...
    Even then the "main repo" to which everyone _pushes_ their updates does not have to be in GitHub or any other public location.


## [Recording Changes](https://coderefinery.github.io/git-intro/commits/)

### Lunch break + [Exercise: Practice creating commits and branches](https://coderefinery.github.io/git-intro/commits/#exercise) until 13:15 (Norway & Denmark) / 14:15 (Finland)
...
- How to save a change without it being a new commit? You mentioned that we could do that, but I don't see the option
    - Do you mean add to a previous commit? (Committing essentially means saving in git). You can "amend" a commit, but I do not see a way to do this in the GitHub interface.
        - Even the _amend_ procedures differ depending on whether you want to modify the most recent commit in your local repo or a commit that has already been pushed to remote repo (e.g. GitHub)
        - The remote repo should be "bare" -- _sans_ working copy. Where is the "non-bare local repo" that GitHub editor lets you access anyway?
...
- I've renamed a branch via VSCode, and then published that branch in the same menu, which created a new branch over on Github. How can I make sure that it stays one branch over on Github? (I forked the repo on Github and then cloned to my local computer so I'm having to use push and pull)
  - You can delete the old branch name on GitHub. Would that work for you?
    Branches are an _extremely_ light weight "entity".  
    ...
    - This is actually an interesting question, I will ping someone that might know better how to do this...
      - renaming branches locally is done with `git branch -m`)
      ...
      - So I'm assuming that VSCode just runs `git branch -m` under the hood, which genuinely renames the branch locally. When I check my branch overview on VSCode, it now shows two branches locally (main and renamed), and three on Github (main, old, renamed). So I guess when it pushes it, there's no way to tell github it's the same branch?
        ...
        - The git output on VSCode shows `git branch -m apple-crumble-new-and-improved [29ms]` so it seems to me to just be regular command line git (the entire output is just command line git). 
          - ok, thank you for sharing! In principle VSCode should do at the same time both the `git branch -m` and the api call to github, but it's probably not doing that? 
...
- How do you find the 'compare' function on github?
  ...
  - To me this doesn't seem to work with branches other than main.
      - changing the URL seems to be the only way [docs](https://docs.github.com/en/pull-requests/committing-changes-to-your-project/viewing-and-comparing-commits/comparing-commits)
      - The link refers to a compare drop-down menu (which I've not been able to find)
          - if you want to compare two branches, this is the patern for the URL `https://github.com/USER/recipe-book/compare/<branch-source>..<branch-target>`
...
- .When I do git graph I get the following message:
  ...
  Is it a version issue or I am missing any extension in VS COde?
    - natively, there is no such command as `git graph`. it is not a version issue 
    - it must be created as an alias: https://coderefinery.github.io/git-intro/aliases/#example-alias-git-graph
      You can create that with the command
      ```bash
      git config --global alias.graph "log --all --graph --decorate --oneline"
      ```
      and then you will be able to use it on any repository on your computer.
      - In other words, there "graph" is on option of `git log`
...
- I created a tag in the local copy of the repo after committing the changes to GitHub, so the tag does not show on Github. The workflow should be then modify file, create tag and then commit?
  - 1. You need to commit before creating a tag. You can also push that commit to github. 
    2. Then you can create a tag
    3. You need to "push" the tag too, with the command `git push --tags`
...
- Did not quite get what is the use/advantage of the tags!
  ...
  - A comfy alias. GitHub has text about _semantic version numbers_.
  - Tags help to inspect the history of the project. Imagine. If you would like to go to a previous version of a project, it is easier to search through tags than all commits. For example: `git checkout v2.3` where `v2.3` is a tag. Or even simpler on github website (next to branches)
- Ok so commit is "saving " the changes under local git repo and pushing is uploading to Github remote repo?
    - committing is like taking a snapshot of your working directory. You can commit either on github or locally. to see the new commit from github to local is called `pull`, while the other way round: from local to github is called `push` 
    - THANKS :)

## [Merging changes and contributing to the project](https://coderefinery.github.io/git-intro/merging/)

### Break + [Exercise:  Merging Branches with pull requests](https://coderefinery.github.io/git-intro/merging/#exercise) Back at XX:20
...
- At step 6 (Delete merged branches), my commits from the new-recipe branch disappeared. What could I have forgotten? [UPDATE: I am blind. There were not in the logs (git log --oneline) but I see them on the individual files. Please excuse me for the confusion! Thank you for your answers.]
    -  UPDATE: did you do 'git add'? You should still see the commit messages you typed in the output of `git log`!
        -  Yes, I did. A comment below offered a solution with `git graph`, which works perfectly.
    - That's puzzling. Are you doing this on github? Is it the same repository? 
        - I did it using the command lines listed in the solution. It was in my forked repository.
          - what do you see with the `git graph` command?
            (note: `git graph` is an alias for )
            ```bash
            git log --oneline --all --graph --decorate
            ```  
             which should show all the commits that were ever done in the repository, even the ones not on the current branch
              - Thank you, it looks great and now I can see my commits from the deleted branch directly in the terminal. +100
...
- I can't find a 'Delete branch' button in my newly merged branch request?
  - you should be able to delete branches from the [list of branches](https://github.com/cr-workshop-exercises/recipe-book/branches) in your repo (you can get to this by adding /branches to the URL or by clicking on "N branches" on the main repo page) - on the right, for each branch, there's a bin/delete icon
...
## Feedback for Day 1 of CodeRefinery workshop
...
### Today was (vote foor all that apply):
too fast:
...
- It was claear and solving the exercies were good!
- The speed was ideal for someone with zero experience. And the notes were simple and easy to follow
- It was very clear and insightful, thank you.
- It's super useful! I am excited for the next days :) The guide is super clear!
- The materials are very clear and the pace is perfect to follow!
- Incredibly clear <3
- Very nice to do this in person, can recommend vs only online. (Twitch works much better than teams, rip)
- Very easy to follow and everything explained clearly!
- Interesting exercices and great handouts
- The setup is very nice
- Fantastic to get answers right away on any questions in this document, thanks!
- Exercises were clear and explanations were easy to follow
- Nice amount of breaks.
- Very clear document, instruction. Thank you!
- i really like how the exercises were went through after the time to complete them. A good amount of time and frequent breaks was great to so we could send the odd email/message and not fall behind on this 
- Nice to have the answeres for the exercies
- Great documentation & step by step clear explanation
- Nice to go through things in the browser first, before moving on to local env
- Realized GUI has become so userfriendly. <3
- Finally understand the "commit" and "pull request" commands/language
- It's quite slowly
- really nice you explain some of the terms, and today it has been the terms whoch are hard to understand 
    - is there a glossary of terms in the course material? could be handy
- good, useful exercises and helpful walk-throughs
- Instructors are very helpful
- Happy with the overview today, slightly too slow pace for my taste, but I anticipate that the pace will be useful when accessing more complex features. 


### One thing to improve for next time:
- Since the networks are not updating fast enough, maybe you could attach images of how the branches should look like in the notes/exercise solutions
- Still the basics of github and codeRefinery are blurry for me 
- There were too many breaks
- maybe could be a little quicker
- I would like to start doing everything in command line, but it is ok to have it done in the web browser. (I found it a bit confusing to learn this alone with cli)
...
- Course covers main active hours in a workday, making it hard to schedule usual regular meetings and lessons at work.

### Any other feedback? General questions?
- An advanced level workshop would be also nice. Maybe you already offer this, and then I would be interested to join because it is a well-structured workshop:)
    - Thanks. This is something we could think about. Currently we run this workshop twice a year. Maybe one of them could be an advanced version. We will have a think. 
    - We also hope that this workshop can get you started to explore a bit more by yourself afterwards :) 
- Will it be possible to have a seperate course for git/version control when working on secure envs? 
    - A trusted research environment (without internet) is just like any other computer so you can use git locally without never uploading the changes to github. I would personally rather work with synthetic data outside the TRE and when I am happy with the code I move it to the TRE.
    - I'm not a course organiser, but I think this would be tricky because each such environment will have its own rules about what is allowed / its own setup of having or not having a local alternative to Github.com
        - Yea this would be a good question to your local IT or secure env provider :) 
        - Well, the principles of git don't change, what you need is git installed locally and you can track versions just normally. If you want to collaborate within the secure env, you can even set up a headless repo in one folder and use that as the 'remote' for other folders, but this is maybe a case for an advance git course, but not so much specific to secure environments
        - For "headless", see option '--bare' from `man git-init`
- I am not really writing software, more smaller scripts and pipelines to analyse sequence data. Is github for me?
  - Version control is still a valid thing to have to make your analysis reproducible, and github is a standard way to share that code - even if it is not software.
  - yes, I agree! Version control can be very helpful to test out an analysis approach / parameters while tracking exactly what changes you made and being able to revert back to previous versions
  - Use of version control definitely is for scripts too. Use of GitHub ... it would be merely a copy of your repo, which for share/access and "backup" could be good.
- Thanks for this workshop, it is really nice you make it, cause it is not easy to get into this if coding dosn't come natural to you. 
